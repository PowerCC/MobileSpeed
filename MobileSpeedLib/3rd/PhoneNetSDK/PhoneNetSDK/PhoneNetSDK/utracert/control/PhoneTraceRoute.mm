...
-(void)startTracert: (int)socketClient andRemoteAddr: (struct sockaddr_in)remoteAddr
{
    ...
    do {
        ...
        MSLPTracerRouteResModel *record = [[MSLPTracerRouteResModel alloc] init:ttl count:kTracertSendIcmpPacketTimes];
...
-(PNetRecTracertIcmpType)receiverRemoteIpTracertRes: (int)ttl packetSeq: (int)seq record: (MSLPTracerRouteResModel *)record
{
