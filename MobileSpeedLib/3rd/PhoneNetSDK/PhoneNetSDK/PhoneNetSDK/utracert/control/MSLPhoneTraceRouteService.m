...
@interface MSLPhoneTraceRouteService()<PhoneTraceRouteDelegate>
...
@implementation MSLPhoneTraceRouteService

static MSLPhoneTraceRouteService *ucTraceRouteService_instance = NULL;
...
+ (instancetype)shareInstance
{
    if (ucTraceRouteService_instance == NULL) {
        ucTraceRouteService_instance = [[MSLPhoneTraceRouteService alloc] init];
    }
...
- (void)tracerouteWithUCTraceRoute:(PhoneTraceRoute *)ucTraceRoute tracertResult:(MSLPTracerRouteResModel *)tracertRes
{
