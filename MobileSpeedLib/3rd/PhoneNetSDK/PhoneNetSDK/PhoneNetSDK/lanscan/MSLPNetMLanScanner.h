 ...
 */
- (void) scanMLan:(MSLPNetMLanScanner *)scanner activeIp:(NSString *)ip;
 ...
 */
- (void) scanMlan:(MSLPNetMLanScanner *)scanner percent:(float)percent;
...
/**
 ...
 @param scanner The instance of `PNetMLanScanner`
 */
- (void) finishedScanMlan:(MSLPNetMLanScanner *)scanner;

@end

@interface MSLPNetMLanScanner : NSObject
