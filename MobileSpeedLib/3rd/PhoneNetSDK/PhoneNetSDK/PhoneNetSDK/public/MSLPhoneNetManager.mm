...
#import "MSLPhoneNetManager.h"
#import "PhonePingService.h"
#import "MSLPhoneTraceRouteService.h"
...
{
    return [MSLPhoneNetManager shareInstance];
}
...
- (void)netStartTraceroute:(NSString *_Nonnull)host tracerouteResultHandler:(NetTracerouteResultHandler _Nonnull)handler
{
    ...
    [[MSLPhoneTraceRouteService shareInstance] startTracerouteHost:host resultHandler:handler];
}

- (void)netStopTraceroute
{
    [[MSLPhoneTraceRouteService shareInstance] uStopTracert];
}

- (BOOL)isDoingTraceroute
{
    return [[MSLPhoneTraceRouteService shareInstance] uIsTracert];
}
