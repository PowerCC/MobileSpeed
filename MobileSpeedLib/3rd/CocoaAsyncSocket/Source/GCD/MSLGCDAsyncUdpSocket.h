...
@class MSLGCDAsyncUdpSocket;

@protocol MSLGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
@interface MSLGCDAsyncUdpSocket : NSObject
...
- (instancetype)initWithDelegate:(nullable id<MSLGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<MSLGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<MSLGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<MSLGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<MSLGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<MSLGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<MSLGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<MSLGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
