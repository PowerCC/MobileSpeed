...
#pragma mark - MSLJSONValueTransformer interface
/**
 ...
 * Just few examples of what can you add to MSLJSONValueTransformer: hex colors in JSON to UIColor,
 ...
 */
@interface MSLJSONValueTransformer : NSObject
