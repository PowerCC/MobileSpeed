...
@implementation MSLJSONKeyMapper
...
{
    NSDictionary *toJSON  = [MSLJSONKeyMapper swapKeysAndValuesInDictionary:map];
...
+ (instancetype)mapper:(MSLJSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions
{
    NSDictionary *toJSON = [MSLJSONKeyMapper swapKeysAndValuesInDictionary:exceptions];
