...
#import "MSLJSONValueTransformer.h"
#import "MSLJSONKeyMapper.h"
 ...
 * does not have matching transformer method in an MSLJSONValueTransformer.
 */
 ...
 */
@interface MSLJSONModel : NSObject <AbstractJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(MSLJSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 * or a property type in your model is not supported by MSLJSONValueTransformer and its categories
 * @see initWithString:usingEncoding:error: for use of custom text encodings
 */
- (instancetype)initWithString:(NSString *)string error:(MSLJSONModelError **)err;
 ...
 * or a property type in your model is not supported by MSLJSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(MSLJSONModelError **)err;
 ...
 * [MSLJSONModelError errorModelIsInvalid] to set the NSError param if the data fails your custom validation
 */
 ...
 * Lookup MSLJSONKeyMapper docs for more details.
 */
