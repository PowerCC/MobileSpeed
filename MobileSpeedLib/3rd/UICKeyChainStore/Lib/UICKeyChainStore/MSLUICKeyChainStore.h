...
extern NSString * const MSLUICKeyChainStoreErrorDomain;
...
@interface MSLUICKeyChainStore : NSObject
...
+ (MSLUICKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (MSLUICKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
@interface MSLUICKeyChainStore (ErrorHandling)
...
@interface MSLUICKeyChainStore (ForwardCompatibility)
...
@interface MSLUICKeyChainStore (Deprecation)
