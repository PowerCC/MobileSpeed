...
#import "MSLGBDeviceInfo_Common.h"
#import "MSLGBDeviceInfo_Subclass.h"

#if TARGET_OS_IPHONE
#import "MSLGBDeviceInfo_iOS.h"
#else
#import "MSLGBDeviceInfo_OSX.h"
#endif
...
@implementation MSLGBDeviceInfo_Common
...
- (BOOL)isOperatingSystemAtLeastOSVersion:(GBOSVersion)version {
    GBOSVersion currentVersion = [MSLGBDeviceInfo deviceInfo].osVersion;
